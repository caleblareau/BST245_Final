...
Under this specification, we can write the MVN distribution for our observations-- <br><br>$$ Y \sim  \mathcal{N} (0, \mathbf{C}), \mathbf{C} = \mathbf{WW^T }+ \mathbf{\Psi}  $$
